...
- [最新版本 v0.1.15](https://github.com/Lsogod/codex-switch-web/releases/tag/v0.1.15)
- [直接下载 macOS DMG](https://github.com/Lsogod/codex-switch-web/releases/download/v0.1.15/Codex-Switch-0.1.15-arm64.dmg)
- [直接下载 Windows x64 安装包](https://github.com/Lsogod/codex-switch-web/releases/download/v0.1.15/Codex-Switch-0.1.15-win-x64.exe)
...
Windows 11 推荐使用 `.exe` 安装包。安装 `v0.1.15` 或更新版本后，后续可以在 App 内直接安装更新。
