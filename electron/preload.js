...
contextBridge.exposeInMainWorld("codexShell", {
  ...
  getAutoUpdateChecksEnabled: () => ipcRenderer.invoke("shell:get-auto-update-checks-enabled"),
  ...
  setOverlayUpdateNoticeVisible: (visible) => ipcRenderer.invoke("shell:set-overlay-update-notice-visible", visible),
